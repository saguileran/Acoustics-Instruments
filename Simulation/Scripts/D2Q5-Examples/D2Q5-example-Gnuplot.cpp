...
int main(void){
  ...
  std::cout << "set xrange[-1:100]; set yrange[0:50]; set zrange[-2:2]" << std::endl;
  ...
  for(t=0;t<tmax;t++){
    ...
    Ondas.PrintGrid("Print-Holes1-Gnuplot.dat"); //Export microphoes data, time vs pressure
    ...
    std::cout << "splot 'Print-Holes1-Gnuplot.dat' " << std::endl;
  }
  return 0;
}
