...
rootfolder = '/home/sebas/Documents/Acoustics-Instruments/Simulation/Scripts/D2Q5-Examples/'
filename = 'Pure.dat'
...
plt.plot(np.log10(abs(data['fft']))[:2500])
...
Datos = np.log10(abs(data['fft']))[:2500]

Datos.to_csv(rootfolder + filename[:-4]+'FT.cvs')
